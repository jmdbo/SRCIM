 ...
 */
public class Vertical1Interface implements ResourceHardwareInterface {
    ...
    public ArrayList<String> getSkills() {
        ...
        ArrayList<String> gAxisSkills = new ArrayList<>();
        Collections.addAll(gAxisSkills,
                Utilities.CylinderG2DUp, Utilities.CylinderG2Down);
        return gAxisSkills;
