 ...
 */
public class Rotate3Interface implements ResourceHardwareInterface {
    ...
    public ArrayList<String> getSkills() {
        ...
        listOfSkills.add(Utilities.Rotate3Left);
        listOfSkills.add(Utilities.Rotate3Right);
        return listOfSkills;
    }
    ...
    public boolean executeSkill(Agent agent, String skill, ResourceHardwareInterface hardware) {
        ...
        try {
            ...
            Logger.getLogger(Rotate3Interface.class.getName()).log(Level.SEVERE, null, ex);
        }
        achieved = true;
        return true;
    }
