 ...
 */
public class Vertical2Interface implements ResourceHardwareInterface {
    ...
    public ArrayList<String> getSkills() {
        ArrayList<String> vVAxisSkills = new ArrayList<>();
        Collections.addAll(vVAxisSkills,
                Utilities.VacuumGripperUp, Utilities.VacuumGripperDown);
        return vVAxisSkills;
    }
