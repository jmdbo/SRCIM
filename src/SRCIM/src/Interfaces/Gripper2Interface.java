 ...
 */
public class Gripper2Interface implements ResourceHardwareInterface {
    ...
    public ArrayList<String> getSkills() {
        ArrayList<String> vacuumHoleSkills = new ArrayList<>();
        Collections.addAll(vacuumHoleSkills,
                Utilities.VaccuumGripperOn, Utilities.VaccuumGripperOff);
        return vacuumHoleSkills;
    }
