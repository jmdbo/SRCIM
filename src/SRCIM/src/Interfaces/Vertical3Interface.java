 ...
 */
public class Vertical3Interface implements ResourceHardwareInterface {
    ...
    public ArrayList<String> getSkills() {
        ...
        listOfSkills.add(Utilities.Cylinder3Down);
        listOfSkills.add(Utilities.Cylinder3Up);
        return listOfSkills;
    }
    ...
    public boolean executeSkill(Agent agent, String skill, ResourceHardwareInterface hardware) {
        ...
        try {
            ...
            Logger.getLogger(Vertical3Interface.class.getName()).log(Level.SEVERE, null, ex);
        }
        achieved = true;
        return true;
    }
