 ...
 */
public class Gripper1Interface implements ResourceHardwareInterface {
    ...
    public ArrayList<String> getSkills() {
        ArrayList<String> gClawSkills = new ArrayList<>();
        Collections.addAll(gClawSkills,
                Utilities.OpenGripper1, Utilities.CloseGripper1);
        return gClawSkills;
    }
